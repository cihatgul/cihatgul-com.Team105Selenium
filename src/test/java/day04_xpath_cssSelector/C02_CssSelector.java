...
public class C02_CssSelector {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (actualTitle.contains(expectedmetin)) System.out.println("Title testi PASSED: ");
        ...
        if (expectedUcret.equals(actualUcretYazisi)) System.out.println("Gift card ucret testi PASSED");
        else System.out.println("Gift card ucret testi FAILED");
